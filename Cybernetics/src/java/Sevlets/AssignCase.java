 ...
 */
public class AssignCase extends HttpServlet {
...
RequestDispatcher r=request.getRequestDispatcher("Header.html");
        ...
        r1.include(request, response);
         ...
         RequestDispatcher r3=request.getRequestDispatcher("HeadPanelReg.html");
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AssignCase</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AssignCase at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
